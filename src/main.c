...
{
  printf("Attempt to write %i bytes\n",len);
...
char packet_bytes[] = {
  ...
  0x00, 0x24, 0xe6, 0xa7, 0x40, 0x00, 0x40, 0x11,
  0x56, 0x1f, 0x7f, 0x00, 0x00, 0x01, 0x7f, 0x00,
  0x00, 0x01, 0x83, 0x60, 0x1b, 0x39, 0x00, 0x10,
  0xfe, 0x23, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66,
  0x67, 0x0a
};
...
*/
  // client transmit
  for (int i=0;i<5;i++) {
    to_client_1_data.content[i] = i*2;
  }
